...
Action()
{
	...
	lr_end_transaction("UC05_TR0X_open_mainpage", 2);
	...
	lr_end_transaction("UC05_TR0X_auth_client", 2);
	...
	lr_end_transaction("UC05_TR0X_open_orders_page", 2);
	...
	lr_end_transaction("UC05_TR0X_open_test_page", 2);
	...
	lr_end_transaction("UC05_TR0X_video_get_id", 2);
	...
	lr_end_transaction("UC05_TR0X_video_get_filename", 2);
	...
	lr_end_transaction("UC05_TR0X_video_stream_init", 2);
	...
	lr_vuser_status_message("Current time in movie: %lf", web_stream_get_param_double("1", 2));

	web_stream_stop("ID=1", "LAST");
	web_stream_close("ID=1", "LAST");

	lr_end_transaction("UC05_TR0X_video_streaming", 2);
