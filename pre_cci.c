# 1 "c:\\users\\asus\\documents\\vugen\\scripts\\uxcroud_inkognito\\uxcroud_inkognito\\\\combined_uxcroud_inkognito.c"
...
# 1 "c:\\users\\asus\\documents\\vugen\\scripts\\uxcroud_inkognito\\uxcroud_inkognito\\\\combined_uxcroud_inkognito.c" 2
...
# 2 "c:\\users\\asus\\documents\\vugen\\scripts\\uxcroud_inkognito\\uxcroud_inkognito\\\\combined_uxcroud_inkognito.c" 2
...
# 3 "c:\\users\\asus\\documents\\vugen\\scripts\\uxcroud_inkognito\\uxcroud_inkognito\\\\combined_uxcroud_inkognito.c" 2
...
# 4 "c:\\users\\asus\\documents\\vugen\\scripts\\uxcroud_inkognito\\uxcroud_inkognito\\\\combined_uxcroud_inkognito.c" 2
...
Action()
{
	...
	lrvtc_connect("127.0.0.1",3456,0x01);
	...
	lr_end_transaction("UC04_T02_", 2);
	...
	web_custom_request("create", 
		...
		"Body={\"orderId\":{orderId},\"screenName\":\"START_PLUGIN\",\"testerId\":493309963}",  
		"LAST");
	...
	web_custom_request("update", 
		...
		"Mode=HTML", 
		"EncType=application/json;charset=UTF-8", 
		"Body={\"orderId\":{orderId},\"id\":{videoId},\"screenName\":\"SCREEN_CAPTURE\"}",  
		"EXTRARES", 
	...
	web_url("order-info", 
		...
		"LAST");
	lr_end_transaction("UC04_T03_PressProitiTest", 2);
	...
	web_custom_request("update_3", 
		...
		"LAST");
lr_end_transaction("UC04_T05_nachat test",2);
...
lr_start_transaction("UC04_T05_prodoljit");
	web_custom_request("update_4", 
		...
		"LAST");
lr_end_transaction("UC04_T05_prodoljit",2);
...
lr_start_transaction("UC04_T08");
	...
	web_url("loadtest.uxcrowd.ru", 
		...
		"LAST");
lr_end_transaction("UC04_T08",2);
	return 0;
}
# 5 "c:\\users\\asus\\documents\\vugen\\scripts\\uxcroud_inkognito\\uxcroud_inkognito\\\\combined_uxcroud_inkognito.c" 2
...
# 6 "c:\\users\\asus\\documents\\vugen\\scripts\\uxcroud_inkognito\\uxcroud_inkognito\\\\combined_uxcroud_inkognito.c" 2
