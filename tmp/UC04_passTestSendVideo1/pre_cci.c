...
Action()
{
	...
	lr_start_transaction("UC04_TR01_startPage");
		...
		"LAST");
	lr_end_transaction("UC04_TR01_startPage", 2);
	web_add_auto_header("X-XSRF-TOKEN", lr_eval_string("{XSRFtoken}"));
	
	lr_start_transaction("UC04_TR02_preseVoiti"); 
		...
		"Mode=HTML", 
		"LAST");
	lr_end_transaction("UC04_TR02_preseVoiti", 2);
	...
	lr_start_transaction("UC04_TR03_preseVoiti2"); 
		...
		"EncodeAtSign=YES", 
		"ITEMDATA", 
		"Name=username", "Value={t_username}", "ENDITEM",  
	...
	lr_end_transaction("UC04_TR03_preseVoiti2", 2);
	...
	lr_start_transaction("UC04_TR04_preseProiti"); 
		...
		"Body={\"orderId\":{order_id},\"screenName\":\"START_PLUGIN\",\"testerId\":{userId}}",  
		"LAST");
		...
		"LAST");
	lr_end_transaction("UC04_TR04_preseProiti", 2);
	...
	lr_end_transaction("UC04_TR05_pressNastoiZapis", 2);

	lr_start_transaction("UC04_TR06_pressNachatTest"); 
	...
	lr_end_transaction("UC04_TR06_pressNachatTest", 2);
	...
	lr_start_transaction("UC04_TR07_pressZakonchitTest");
		...
		"LAST");
	lr_end_transaction("UC04_TR07_pressZakonchitTest", 2);
	...
	web_url("profile_4", 
		...
		"Mode=HTML", 
		"LAST");
	lr_end_transaction("UC04_TR09_pressOKafterUpload", 2);
	...
	lr_start_transaction("UC04_TR10_logOut");
		...
		"EncType=", 
		"LAST");
	lr_end_transaction("UC04_TR10_logOut", 2);
